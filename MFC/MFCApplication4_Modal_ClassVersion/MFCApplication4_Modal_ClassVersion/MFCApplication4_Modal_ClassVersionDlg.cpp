...
// MFCApplication4_Modal_ClassVersionDlg.cpp: 구현 파일
//
...
CMFCMainDlg::CMFCMainDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFCAPPLICATION4_MODAL_CLASSVERSION_DIALOG, pParent)
{
...
// CMFCApplication4ModalClassVersionDlg 메시지 처리기
