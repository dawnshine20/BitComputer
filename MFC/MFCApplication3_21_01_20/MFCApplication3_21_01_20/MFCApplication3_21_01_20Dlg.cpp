...
BEGIN_MESSAGE_MAP(CMFCApplication3210120Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_COMMAND(ID_MENU_MESSAGEBOX, &CMFCApplication3210120Dlg::OnMenuMessagebox)
	ON_COMMAND(ID_MENU_CLOSE, &CMFCApplication3210120Dlg::OnMenuClose)
	ON_COMMAND(Sub1, &CMFCApplication3210120Dlg::OnSub1)
END_MESSAGE_MAP()
...
///
/// </summary>
void CMFCApplication3210120Dlg::OnMenuMessagebox()
{
...
void CMFCApplication3210120Dlg::OnMenuClose()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	OnOK();
}
...
void CMFCApplication3210120Dlg::OnSub1()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	MessageBox(_T("안녕"));
}
